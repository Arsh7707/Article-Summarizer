...
const Demo = () => {
  ...
  useEffect(() =>{
      const articlesFromLocalStorage = JSON.parse(localStorage.getItem('articles')) //converting web server data to js object
  ...
  const handleSubmit = async (e) => {
    ...
    if(data?.summary) {
      ...
      console.log(newArticle);
       {/*local storage only contains string*/}
    ...
    <section className='mt-16 w-full max-w-xl'>
      ...
      className='my-10 max-w-full flex justify-center items-center'>
        {isFetching ?(
          ...
          <p className='font-inter font-bold text-black text-center'>BUMMER
          <br />
